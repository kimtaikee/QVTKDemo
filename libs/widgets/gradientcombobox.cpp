...
#else
GradientDataList GradientComboBoxPrivate::sGradientList =
        GradientDataList()<< GradientData(QObject::tr("Alpine"), QColor(71, 92, 123), QColor(250, 249, 228))
                          << GradientData(QObject::tr("Lake"), QColor(85, 32, 150), QColor(238, 231, 213))
                          << GradientData(QObject::tr("Army"), QColor(117, 151, 123), QColor(192, 190, 163))
                          << GradientData(QObject::tr("Mint"), QColor(135, 248, 173), QColor(233, 159, 201))
                          << GradientData(QObject::tr("Atlantic"), QColor(41, 51, 52), QColor(125, 130, 162))
                          << GradientData(QObject::tr("Neon"), QColor(185, 222, 75), QColor(205, 54, 193))
                          << GradientData(QObject::tr("Aurora"), QColor(57, 60, 82), QColor(212, 77, 243))
                          << GradientData(QObject::tr("Pearl"), QColor(234, 220, 208), QColor(239, 206, 250))
                          << GradientData(QObject::tr("Avocado"), QColor(0, 18, 3), QColor(251, 249, 57))
                          << GradientData(QObject::tr("Plum"), QColor(24, 4, 6), QColor(226, 220, 113))
                          << GradientData(QObject::tr("Beach"), QColor(220, 137, 68), QColor(236, 238, 252))
                          << GradientData(QObject::tr("Rose"), QColor(58, 84, 33), QColor(179, 38, 31))
                          << GradientData(QObject::tr("Candy"), QColor(115, 53, 87), QColor(169, 221, 225))
                          << GradientData(QObject::tr("Solar"), QColor(132, 4, 3), QColor(255, 205, 30))
                          << GradientData(QObject::tr("CMYK"), QColor(90, 183, 235), QColor(46, 43, 44))
                          << GradientData(QObject::tr("South West"), QColor(119, 76, 47), QColor(93, 153, 209))
                          << GradientData(QObject::tr("Deep Sea"), QColor(49, 2, 91), QColor(191, 233, 255))
                          << GradientData(QObject::tr("Starry Night"), QColor(28, 47, 61), QColor(244, 207, 96))
                          << GradientData(QObject::tr("Fall"), QColor(67, 101, 98), QColor(245, 200, 61))
                          << GradientData(QObject::tr("Sunset"), QColor(31, 11, 42), QColor(255, 245, 215))
                          << GradientData(QObject::tr("Fruit Punch"), QColor(255, 130, 0), QColor(243, 88, 137))
                          << GradientData(QObject::tr("Thermometer"), QColor(53, 56, 217), QColor(140, 26, 45))
                          << GradientData(QObject::tr("Island"), QColor(184, 103, 69), QColor(171, 202, 83))
                          << GradientData(QObject::tr("Watermelon"), QColor(42, 48, 34), QColor(227, 98, 98));
